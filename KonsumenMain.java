...
public class KonsumenMain extends AppCompatActivity {
    private DatabaseHelper helperku;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_konsumen_main);
    ...
    public void register_process(){
        ...
        View inputnya = li.inflate(R.layout.konsumen_regis,null);
        ...
        dialognya
                ...
                .setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(isNotExist){
                            helperku.addKonsumen(username.getText().toString(),password.getText().toString(),nama.getText().toString(),nomorhp.getText().toString(),alamat.getText().toString());
    ...
    public void login_process(){
        ...
        boolean isRight = helperku.cekLoginKonsumen(username.getText().toString(),password.getText().toString());
        if(isRight){
            Toast.makeText(getBaseContext(),"Login Sukses!",Toast.LENGTH_SHORT).show();
            Intent intenku = new Intent(getBaseContext(),KonsumenHome.class);
